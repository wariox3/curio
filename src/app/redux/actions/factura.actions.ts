...
export const agregarPagosFacturaActiva = createAction(
  '[Factura] Agregar pago a factura activa',
  props<{ cuenta_banco: number; cuenta_banco_nombre: string; pago: number }>(),
);

export const limpiarPagosFacturaActiva = createAction(
  '[Factura] Limpiar pagos de factura activa',
);

export const actualizarValorAfectadoFacturaActiva = createAction(
  '[Factura] Actualizar valor afectado factura activa',
);
